    ...
    <div class="budget-create">
        ...
        <form @submit.prevent="createBudget" class="budget-form">
            <div class="form-group">
                ...
                <input id="budgetName" v-model="form.name" type="text" required
                    :class="{ 'error': validationErrors.name }" placeholder="Enter budget name">
            ...
            <div class="form-group">
                ...
                <select id="currency" v-model="form.currency" required :class="{ 'error': validationErrors.currency }">
...
import currencies from '../../data/valid_currencies.json'
...
const createBudget = async () => {
    ...
    try {
        ...
        if (error.response) {
            errorMessage.value = error.response.data.message || 'Failed to create budget'
        } else if (error.request) {
            errorMessage.value = 'Network error. Please try again.'
        } else {
            errorMessage.value = error.message || 'Failed to create budget'
        }
    } finally {
